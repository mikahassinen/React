        ...
        return (
            <div className='note-exercise-l'>
                <div className='flex-row'>
                    ...
                    <Button primary onClick={() => addImage(imageUrl)}>Add</Button>

                    <Button warn onClick={resetImages}>Reset Images</Button>
                    <Button primary onClick={shuffleImages}>Shuffle Images</Button>
...
const mapDispatchToProps = ({
    ...
    removeImage: index => (dispatch, getState) => dispatch({type: REMOVE_IMAGE, payload: index,}),

    //addImage: add => (dispatch, getState) => dispatch({type: ADD_IMAGE, payload: {toAdd: add,},}),
    addImage: (nameAndUrl) => (dispatch, getState) => dispatch({type: ADD_IMAGE, payload: nameAndUrl,}),

    //onCatAdded={(nameAndImage) => store.dispatch({ type: ADD_CAT, payload: nameAndImage, })}
    shuffleImages: () => (dispatch, getState) => dispatch({type: SHUFFLE_IMAGES,}),
    /* TODO
     * removeImage
     * addImage,
     * shuffleImages,
